        ...
        {isMenuOpen && (
          <>
            <motion.div
              ...
              className="fixed inset-0 bg-black/30 backdrop-blur-[2px] z-40 cursor-pointer"
            />
            <motion.div
              ...
              animate="open"
              exit="closed"
              className="fixed top-0 right-0 h-screen w-72 bg-gradient-to-b from-[#0A1D14] to-[#0F2A1D] shadow-2xl p-8 z-40 flex flex-col"
            >
              {/* Profile Section */}
              {session && (
                ...
                {session ? (
                  <>
                    ...
                    >
                      ...
                      <span className="text-white/70 group-hover:text-white/90 transition-colors duration-200">Profil</span>
                    </Link>
                    <motion.button
